...
object GameTiles {
    ...
    val FLOOR_TRAV = characterTile('*', GameColors.FLOOR_TRAV_FOREGROUND, GameColors.FLOOR_TRAV_BACKGROUND)
    val FLOOR_NON_TRAV = characterTile('x', GameColors.FLOOR_NTRAV_FOREGROUND, GameColors.FLOOR_NTRAV_BACKGROUND)
